...
Every line names its command, its lanes and its commit. Dates: the gate run of local 2026-09-21 (its rows are stamped 2026-09-22 UTC), unless a line gives its own. Bend: 2.0.16 at `15ae0c8`. Original: `toon_rust` `f955c67` (`toon 0.2.4`).
