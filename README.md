...
- **Proved:** `bun /tmp/bend/bend2/main.ts port/PROOF.bend` → `All terms check.`, 422 laws, unsafe 0 = 0 `@unsafe` + 0 template instances, bend 2.0.16.
