...
def _proposed_e():
    ...
    dec("toonedge_header_key_with_colon", "a: [1]: x\n", cls="toon-edge", note="S2.134: key is everything before '[' -> {\"a:\":[\"x\"]}")
    dec("toonedge_header_in_quoted_value", "a: \"x[1]: y\"\n", cls="toon-edge", note="S10.83: bracket inside a quoted value is taken as a header")
    dec("toonerr_cap_in_quoted_value", "note: \"see [999999999999]: x\"\n", cls="toon-error", note="S10.84: the cap fires inside a quoted value")
