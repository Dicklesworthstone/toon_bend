...
- Approver: the repository owner, 2026-09-20, who delegated the ruling to the author in these words: "You decide on everything. I approve whatever you want to do." The author's ruling follows under Resolution
- Resolution: ACCEPTED as the state of this release, with the work it names carded (`perf/EXPERIMENTS.md` EXP-005, EXP-006) and left open as beads (`toon_bend-0m1`, `toon_bend-oiu`, `toon_bend-p47`, `toon_bend-okl`). Scoped contract: bytes are identical; a number that is not an integer below 2^48 costs 45 to 306 times the original's time (the widest and the narrowest factor this entry measured), linearly in the input.
