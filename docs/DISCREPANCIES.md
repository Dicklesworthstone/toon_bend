...
### DISC-013 — a number that is not a small integer costs 45 to 300 times the original's time   [2026-09-20 | Performance | OPEN]
...
- Approver: pending. Beads: the Phase 5 candidates (`br list`): a short decimal's own digits when printing, the 10-fold cost of string-heavy input
- Resolution: n/a while OPEN
