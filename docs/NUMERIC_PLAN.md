...
> **Amendment (2026-09-20, ARCH §11 A7).** The closed law names in this table (`f64_from_2p53_plus_1`, `pow10_22`, `pow10_23`, `pow10_292`, `serde_fit_boundary`, `length_cap_boundary` and the "seven pinned bit patterns") were PLANNED names. None of them is in `port/LAWS.bend`. Those rows are golden-tested by the cases they name; the numeric laws that are stated are the `div_pow10_*`, `div_p10_*`, `from_dec_p10_*`, `serde_*`, `token_*`, `show_*_fast_*`, `stats_*` and `bn_add_carry` closed laws and the 157 `golden_<case>` whole-pipeline laws.
