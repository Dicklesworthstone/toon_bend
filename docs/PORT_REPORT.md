...
| the laws bite | the whole set was last run complete over the 22 mutants that existed earlier: `{"laws_in_proof": 123, "reduced": true, "mutants": 22, "killed": 22, "survived": [], "not_evidence": [], "verdict": "STRONG"}`. Round 13 wrote three more (M24, M25, M26), which survived the full proof until the laws of 2026-09-20 pinned them: `{"laws_in_proof": 129, "reduced": true, "mutants": 3, "killed": 3, "survived": [], "not_evidence": [], "verdict": "STRONG"}`. All 25 in one run: not yet (the host stopped it for memory; bead `toon_bend-sp5`). `scripts/law-mutation.sh` itself: INCONCLUSIVE on the three modules (no valid textual site) | `scripts/hand-mutants.py` |
