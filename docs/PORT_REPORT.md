...
| convergence met for the tier | `{"tier": "T2", "rounds": 12, "clean": 5, "clean_tail": 0, "last_two_clean": false, "non_author_round": true, "open_oq": [], "open_disc": [], "verdict": "NOT_CONVERGED", "missing": ["clean rounds since last reset 0 < 2"]}`: FAILS | `scripts/converge.sh` |
...
- against the STRONGEST build of the original (the `opt-level=3` incumbent PLAN §2 promised, built 2026-09-20; it is 1.389× the pinned build, cv 1.3% / 2.4%, `perf/evidence/INCUMBENT-O3.vs-z-expand.json`): 1.989× on 40000 expanded lines and **0.773× on 20 rows of 1200 fields — the port is slower there**, where the pinned build gave 3.06× and 1.27× (`perf/evidence/INCUMBENT-O3.expand.json`, `.wide-rows.json`; NE-006). A ratio taken against the pinned build flatters the port by about 1.4× on this workload
