...
list-cell wraps under `KT_PUT_GO` there. For an object of at most 8 members (round 20's R20-4: the key set is built when the 9th joins) the chain itself answers "is this key already here"
