...
**COUNTED deltas across builds (2026-09-23; found and closed under `toon_bend-2ul`).** A cachegrind count is deterministic run to run
...
--decode`, +12.3M of the cell's +13.0M, +1.84%); the encode arm's walk went the other way between `faaccac` and EXP-031
