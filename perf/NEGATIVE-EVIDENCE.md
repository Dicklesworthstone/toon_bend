...
- Provenance: no build, no binary, no capture. `port/` was never modified. Carded and withdrawn the same day from reading four defs of `port/decode.bend` at the frozen tree (`port/` byte-identical across `9c9039e`, `55ec958`, `c5f3b46`; binary `sha256 825e44de69c3a4e6c0d442ea`)
