...
RULES = [  # (regex on the law name, rows) — first match wins
 ...
 (r"(expansion_cap_on_|expand_cap_is_256_|expand_order_first_insertion)", ["safe path expansion", "JSON writer B"]),
 ...
 (r"(decode_error_ends_pass|decode_root_ends_pass)$", ["structural decoding"]),
